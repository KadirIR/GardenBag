...
if (isset($_POST['sepete_ekle'])) {
    ...
    try {
        ...
        $stmt->bindParam(1, $kulid, PDO::PARAM_STR);  // email is string, so use PDO::PARAM_STR
...
<body>
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="../fav.php"><i class="fa-sharp fa-regular fa-heart like"></i></a></li>
                <li id="lg-bag"><a href="../sepet/sepet.php"><i class="fa-solid fa-cart-shopping"></i></a></li>
    ...
    <section id="prodetalis" class="section-p1">
        ...
        <div class="single-pro-image">
            <img src="../<?=$data['resim_url']?>" width="100%" id="MainImg" alt="" style="border: 5px solid gray"/>
        </div>
        <div class="single-pro-details">
            <div style="display: flex">
                <a href="../index.php" style="text-decoration: none; color: black; padding-right: 5px">Anasayfa</a>
                <a href="#" style="text-decoration: none; color: black">/ <?=$data['kategori']?> </a>
            </div>
            <h4><?=$data['ad']?></h4>
            <h2><?=$data['fiyat']?>₺</h2>
            <div style="display: flex; align-items: center; gap: 10px">
                <form method="post" action="flower1.php">
